...
def get_precincts(data):
    return [remove_tags(data[i]) for i in range(PRECINCTS_START_IDX, PRECINCTS_END_IDX + 1, PRECINCTS_OFFSET)]


def generate_csv(candidate, counties, precincts, li_data):
...
if __name__ == "__main__":
    ...
    generate_csv("Sanders", counties, precincts, li_data)
